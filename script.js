...
document.querySelector('#createTable').addEventListener('click', function() {
    ...
    let tableTitle = document.querySelector('#tableTitle').value;
    ...
    // SÜTUN OLUŞTURMA KODLARI:
        ...
        tableDeleteButton.id = `delete${columnCounter}`;
